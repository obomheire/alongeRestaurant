        ...
        <Formik
          ...
          {props => (
            <View style={styles.view2}>
              <View>
                <Text style={styles.text2}>New on alongeRestaurant ?</Text>
              </View>
              ...
              <View style={styles.view15}>
                <Text style={styles.text3}>
                  By creating or logging into your account you
                </Text>
                <View style={styles.view16}>
                  <Text style={styles.text3}>agree with our </Text>
        ...
        <View style={styles.view19}>
          <View style={styles.view20}>
            <Text style={styles.text6}>
              Already have an account with alongeRestaurant ?
            </Text>
          </View>
